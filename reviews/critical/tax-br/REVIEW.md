# Review Package — tax-br

## Skill
tax-br

## Purpose
Analyze Brazilian tax applicability across IRPJ, CSLL, PIS, Cofins, ICMS, ISS, IPI, IRRF, INSS, withholding, IBS, CBS, and reform transitions
...
DOMAIN, LEGAL, TAX, GOVERNANCE

## Key Source Hierarchy
T1-and-corporate per skills/**/tax-br/sources.md — see its "Primary Authorities" and "Conflict Resolution" sections.

## Critical References
See `skills/**/tax-br/references/` and the "References Loaded On Demand" section of its `sources.md`.

## Gold-Case Categories
5 cases defined, covering: BOUNDARY, FAIL_SAFE, HIGH_RISK, INSUFFICIENT_CONTEXT, NORMAL. Full cases at `evals/behavioral/critical/tax-br/`.

## Known Gaps
- `human_review`: status is "pending", requires "approved"
- `source_freshness_alert`: sped:CHANGED_UNREVIEWED, sefaz:CHANGED_UNREVIEWED, municipal-tax:CHANGED_UNREVIEWED
- `source_verification`: none of [receita, sped, planalto, sefaz, municipal-tax, econet] has ever been human-verified (last_verified is null for all)
